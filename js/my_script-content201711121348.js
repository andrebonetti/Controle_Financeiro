...
$(".categoria-resumo").each(function() {
    ...
    $(this).find(".sub_categoria-resumo").each(function() {
        ...
        var div_subcategoria = $(this);
        var id_subcategoria  = $(this).data("id-subcategoria");
        
        alert(div_subcategoria.attr("class"));
        
        $(".IdSubCategoria-"+id_subcategoria).each(function(){  
            
            var info_config = $(this).find(".info-config");
            
            var valor       = info_config.data("valor");
            var descricao   = info_config.data("descricao");
            
            alert("sub-categoria: " + $(this).attr("class") + " valor: " + valor + " descrição: " + descricao);
            
            /*$(div_subcategoria).find("table.content").append(
                "<tr>"
